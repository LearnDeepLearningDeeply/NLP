...
$PYTHONPATH $PY --mode TRAIN --model_dir $MODEL_DIR \
...
$PYTHONPATH $PY --mode DECODE --model_dir $MODEL_DIR \
	...
	--N 567 --decode_output $DECODE_OUTPUT
	
$PYTHONPATH $SEG $DECODE_OUTPUT.src $DECODE_OUTPUT $SEG_PATH
