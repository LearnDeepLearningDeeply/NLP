...
def read_data(sent_file_path, tag_file_path, loc_file_path, eng_file_path, dat_file_path, seg_file_path):
	with open(sent_file_path, 'r') as fin1, open(tag_file_path, 'r') as fin2, open(loc_file_path, 'r') as fin3, open(eng_file_path, 'r') as fin4, open(dat_file_path, 'r') as fin5, open(seg_file_path, 'w') as fout:
